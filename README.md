...
```sh
  cd my-folder
  git clone git@github.com:rmiyoyo/Awesome-Books.git
```
...
If you like this project, create a pull request or hit us up on Raphael's  [Twitter](https://twitter.com/r_miyoyo) or Koppai's [Twitter](https://twitter.com/_koppai_) for any other thing.
